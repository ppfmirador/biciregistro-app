...
const handleInitiateTransferRequest = async (data: any, context: any) => {
  ...
  const newRequest = {
    ...
    fromOwnerId: uid,
    fromOwnerEmail: context.auth.token.email,
...
const handleCreateAccount = async (data: any, context: any) => {
  ...
  const { accountData, role, creatorId } = data as {
    accountData:
      | BikeShopAdminFormValues
      | NgoAdminFormValues
      | NewCustomerDataForShop;
...
export const api = onCall(callOptions, async (req) => {
  ...
  try {
    switch (action) {
      case "createBike":
        return await handleCreateBike(req.data, req);
      case "getMyBikes":
        return await handleGetMyBikes(req.data, req);
      case "getPublicBikeBySerial":
        return await handleGetPublicBikeBySerial(req.data, req);
      case "reportBikeStolen":
        return await handleReportBikeStolen(req.data, req);
      case "markBikeRecovered":
        return await handleMarkBikeRecovered(req.data, req);
      case "initiateTransferRequest":
        return await handleInitiateTransferRequest(req.data, req);
      case "respondToTransferRequest":
        return await handleRespondToTransferRequest(req.data, req);
      case "getUserTransferRequests":
        return await handleGetUserTransferRequests(req.data, req);
      case "updateUserRole":
        return await handleUpdateUserRole(data, req);
      case "deleteUserAccount":
        return await handleDeleteUserAccount(data, req);
      case "updateHomepageContent":
        return await handleUpdateHomepageContent(data, req);
      case "getHomepageContent":
        return await handleGetHomepageContent();
      case "createAccount":
        return await handleCreateAccount(data, req);
      case "createOrUpdateRide":
        return await handleCreateOrUpdateRide(data, req);
