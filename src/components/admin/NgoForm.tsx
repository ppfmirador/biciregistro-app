...
export const NgoForm: React.FC<NgoFormProps> = ({
  onSubmit,
  initialData,
  isLoading,
  isEditMode,
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div className="space-y-4">
        <h3 className="text-lg font-medium flex items-center">
          <HeartHandshake className="mr-2 h-5 w-5 text-primary" /> Detalles de
          la ONG
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-1">
            ...
            <Input
              ...
              className={errors.publicWhatsapp ? "border-destructive" : ""}
            />
      ...
      <div className="space-y-4">
        <h3 className="text-lg font-medium flex items-center border-b pb-2">
          <MapPin className="mr-2 h-5 w-5 text-primary" /> Detalles de Rodadas
        </h3>
      ...
      <div className="space-y-4">
        <h3 className="text-lg font-medium flex items-center">
          <User className="mr-2 h-5 w-5 text-primary" /> Cuenta y Contacto
        </h3>
        <div className="space-y-1">
