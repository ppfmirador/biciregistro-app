...
import { bikeShopAdminSchema, type BikeShopAdminFormValues } from '@/lib/schemas';
...
export const BikeShopForm: React.FC<BikeShopFormProps> = ({ onSubmit, initialData, isLoading, isEditMode }) => {
  const { register, handleSubmit, control, watch, setValue, formState: { errors }, reset } = useForm<BikeShopAdminFormValues>({
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div className="space-y-4">
        <h3 className="text-lg font-medium flex items-center"><Building className="mr-2 h-5 w-5 text-primary" /> Detalles de la Tienda</h3>
      ...
      {/* Contact Person */}
      <div className="space-y-4">
        <h3 className="text-lg font-medium flex items-center"><User className="mr-2 h-5 w-5 text-primary" /> Persona de Contacto</h3>
         <div className="space-y-1">
