...
export const getMyBikes = onCall({
  ...
  try {
    ...
    throw new HttpsError(
      "internal",
      "An internal error occurred while fetching your bikes."
    );
  }
});
...
export const getPublicBikeBySerial = onCall({
  ...
  try {
    ...
    throw new HttpsError(
      "internal",
      "An internal error occurred while fetching bike details."
    );
  }
});
...
export const reportBikeStolen = onCall({
  ...
  try {
    ...
    throw new HttpsError(
      "internal",
      "An internal error occurred while reporting the theft."
    );
  }
});
...
export const markBikeRecovered = onCall({
  ...
  try {
    ...
    throw new HttpsError(
      "internal",
      "An internal error occurred while marking the bike as recovered."
    );
  }
});
...
export const initiateTransferRequest = onCall({
  ...
  try {
    ...
    throw new HttpsError(
      "internal",
      "An internal error occurred while initiating the transfer request."
    );
  }
});
