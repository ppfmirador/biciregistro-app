...
export const metadata: Metadata = {
  ...
  description:
    "Encuentra y únete a los eventos organizados por ONGs y colectivos ciclistas en tu zona. Filtra por país, estado, modalidad y nivel para encontrar el evento perfecto para ti.",
};
