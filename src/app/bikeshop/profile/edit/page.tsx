...
import {
  bikeShopProfileSchema,
  type BikeShopProfileFormValues,
} from "@/lib/schemas";
...
function EditBikeShopProfilePageContent() {
  ...
  const {
    ...
    watch,
    setValue,
  } = useForm<BikeShopProfileFormValues>({
  ...
  useEffect(() => {
    ...
    if (!user || user.role !== "bikeshop") {
      toast({
        ...
        description: "Debes ser una tienda para editar este perfil.",
        variant: "destructive",
      });
  ...
  const handleProfileSubmit = async (data: BikeShopProfileFormValues) => {
    ...
    try {
      ...
      toast({
        ...
        description: "La información de tu tienda ha sido guardada.",
      });
    ...
    <div className="space-y-6">
      ...
      <Card className="max-w-3xl mx-auto shadow-xl">
        <CardHeader>
          ...
          <CardDescription>
            Actualiza la información pública y de contacto de tu tienda. El
            correo electrónico (
          ...
          >
            <section className="space-y-4">
              <h3 className="text-lg font-medium flex items-center border-b pb-2">
                <Building className="mr-2 h-5 w-5 text-primary" /> Detalles de
                la Tienda
              </h3>
            ...
            <section className="space-y-4">
              <h3 className="text-lg font-medium flex items-center border-b pb-2">
                <User className="mr-2 h-5 w-5 text-primary" /> Persona de
                Contacto
              </h3>
              <div className="space-y-1">
