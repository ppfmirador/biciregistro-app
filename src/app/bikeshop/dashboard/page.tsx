...
export default function BikeShopDashboardPage() {
  ...
  const [analyticsData, setAnalyticsData] = useState<ShopAnalyticsData | null>(
    null,
  );
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground text-sm sm:text-base">
            Administra las bicicletas que registras y visualiza tus
            estadísticas.
          </p>
        </div>
            ...
            <Card className="shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <Link href="/bikeshop/register-sold-bike" passHref>
                  <Button className="w-full">Registrar Bici</Button>
                </Link>
              </CardContent>
            </Card>
            ...
            <Card className="shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <Link href="/bikeshop/inventory" passHref>
                  <Button className="w-full">Ver Bicicletas Registradas</Button>
                </Link>
              </CardContent>
            </Card>
          ...
          <Card>
            <CardHeader>
              <div>
                ...
                <CardDescription>
                  Crea, edita o elimina los eventos de tu tienda.
                </CardDescription>
              </div>
              <div className="pt-4">
        ...
        <TabsContent value="analytics" className="mt-6">
          <Card className="max-w-5xl mx-auto shadow-lg">
            <CardHeader>
              ...
              <CardDescription>
                Visualiza métricas clave de tu actividad en la aplicación.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                <StatCard
                  title="Bicis Registradas por Tienda"
                  value={analyticsData?.totalBikesByShop ?? 0}
                  icon={<Bike className="h-7 w-7 text-primary" />}
                  description="Total de bicis registradas por ti."
                  isLoading={isAnalyticsLoading}
                />
                <StatCard
                  title="Usuarios Registrados por Tienda"
                  value={analyticsData?.totalUsersByShop ?? 0}
                  icon={<Users className="h-7 w-7 text-primary" />}
                  description="Total de clientes registrados por ti."
                  isLoading={isAnalyticsLoading}
                />
                <StatCard
                  title="Reportes de Robo (Tus Clientes)"
                  value={analyticsData?.stolenBikes ?? 0}
                  icon={<AlertTriangle className="h-7 w-7 text-destructive" />}
                  description="Bicis de tus clientes marcadas como robadas."
                  isLoading={isAnalyticsLoading}
                />
                <StatCard
                  title="Transferencias (Tus Clientes)"
                  value={analyticsData?.transferredBikes ?? 0}
                  icon={<ArrowRightLeft className="h-7 w-7 text-green-600" />}
                  description="Transferencias de propiedad de tus clientes."
                  isLoading={isAnalyticsLoading}
                />
              </div>
