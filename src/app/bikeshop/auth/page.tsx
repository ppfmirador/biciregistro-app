        ...
        <CardContent>
          <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
            <TabsList className="grid w-full grid-cols-2 mb-4 sm:mb-6">
              ...
              <TabsTrigger value="signup" disabled>Registrarse (Admin)</TabsTrigger> 
            </TabsList>
            ...
            <TabsContent value="signup">
              <p className="text-center text-muted-foreground">El registro de tiendas se realiza a través del panel de administración.</p>
