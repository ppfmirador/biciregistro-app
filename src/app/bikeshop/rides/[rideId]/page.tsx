  ...
  useEffect(() => {
    ...
    if (!user || user.role !== "bikeshop") {
      toast({
        ...
        description: "Debes ser una Tienda para gestionar eventos.",
        variant: "destructive",
      });
        ...
        <CardHeader>
          <CardTitle className="text-2xl font-headline flex items-center">
            {isCreating ? (
              ...
              <Save className="mr-3 h-6 w-6 text-primary" />
            )}
            {isCreating ? "Crear Nuevo Evento" : "Editar Evento"}
          </CardTitle>
          <CardDescription>
            {isCreating
              ? "Completa los detalles para publicar un nuevo evento para tu tienda."
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-1">
                      ...
                      <PopoverTrigger asChild>
                        <Button
                          ...
                          className={cn(
                            ...
                            errors.rideDate && "border-destructive",
                          )}
                        >
              ...
              <p className="text-xs text-muted-foreground pt-1">
                La hora se registrará en la zona horaria de tu navegador.
                Asegúrate de que coincida con la hora local del evento.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-1">
                <Label htmlFor="cost">
                  Costo (MXN, si no aplica dejar en 0)
                </Label>
                <Input
                  id="cost"
                  type="number"
