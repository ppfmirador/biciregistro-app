  ...
  useEffect(() => {
    ...
    if (!user || user.role !== "ngo") {
      toast({
        ...
        description: "Debes ser una ONG para editar este perfil.",
        variant: "destructive",
      });
  ...
  const handleProfileSubmit = async (data: NgoProfileFormValues) => {
    ...
    try {
      ...
      toast({
        ...
        description: "La información de tu organización ha sido guardada.",
      });
    ...
    <div className="space-y-6">
      ...
      <Card className="max-w-3xl mx-auto shadow-xl">
        <CardHeader>
          ...
          <CardDescription>
            Actualiza la información pública y de contacto de tu organización.
            El correo electrónico (
            <span className="font-semibold">{user?.email || "N/A"}</span>) no se
            puede cambiar.
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          >
            ...
            <section className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <Input
                    ...
                    className={
                      errors.publicWhatsapp ? "border-destructive" : ""
                    }
                  />
                  {errors.publicWhatsapp && (
                    <p className="text-xs text-destructive">
                      {errors.publicWhatsapp.message}
                    </p>
                  )}
                </div>
              </div>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      ...
                      >
                        ...
                        <SelectTrigger
                          className={
                            errors.profileState ? "border-destructive" : ""
                          }
                        >
                          <SelectValue
                            placeholder={
              ...
              <div className="space-y-1">
                <Label htmlFor="whatsappGroupLink">
                  Enlace del Grupo de WhatsApp (para invitaciones)
                </Label>
                <Input
                  ...
                  className={
                    errors.whatsappGroupLink ? "border-destructive" : ""
                  }
                />
            ...
            <section className="space-y-4">
              <h3 className="text-lg font-medium flex items-center border-b pb-2">
                <MapPin className="mr-2 h-5 w-5 text-primary" /> Detalles de
                Rodadas
              </h3>
              <div className="space-y-2">
                ...
                {errors.meetingDays && (
                  <p className="text-xs text-destructive">
                    {typeof errors.meetingDays.message === "string"
                      ? errors.meetingDays.message
                      : "Error en selección de días."}
                  </p>
                )}
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-1">
                  <Label htmlFor="meetingPointMapsLink">
                    Enlace de Google Maps
                  </Label>
                  <Input
                    id="meetingPointMapsLink"
                    type="url"
                    {...register("meetingPointMapsLink")}
                    placeholder="https://maps.app.goo.gl/..."
                    className={
                      errors.meetingPointMapsLink ? "border-destructive" : ""
                    }
                  />
                  {errors.meetingPointMapsLink && (
                    <p className="text-xs text-destructive">
                      {errors.meetingPointMapsLink.message}
                    </p>
                  )}
                </div>
              </div>
            ...
            <section className="space-y-4">
              <h3 className="text-lg font-medium flex items-center border-b pb-2">
                <User className="mr-2 h-5 w-5 text-primary" /> Información de
                Contacto (Interno)
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1">
                ...
                <div className="space-y-1">
                  ...
                  <Input
                    ...
                    className={
                      errors.contactWhatsApp ? "border-destructive" : ""
                    }
                  />
