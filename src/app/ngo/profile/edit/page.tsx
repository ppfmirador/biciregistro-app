...
function EditNgoProfilePageContent() {
  ...
  const handleChangePassword = async () => {
    ...
    try {
      ...
      const errorMessage = error instanceof FirebaseError ? error.message : "No se pudo cambiar la contraseña.";
      ...
      <Card className="max-w-3xl mx-auto shadow-xl">
        CardHeader>
          div className="flex items-center gap-2 mb-2">
            ...
            CardTitle className="text-3xl font-headline">Editar Perfil de la OrganizaciónCardTitle>
          div>
          CardDescription>
        ...
        CardContent>
          form onSubmit={handleSubmit(handleProfileSubmit)} className="space-y-6">
            ...
            section className="space-y-4">
                h3 className="text-lg font-medium flex items-center border-b pb-2">HeartHandshake className="mr-2 h-5 w-5 text-primary" /> Información Pública de la ONGh3>
                div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  div className="space-y-1">
                    Label htmlFor="ngoName">Nombre de la ONGLabel>
                  ...
                  div>
                  div className="space-y-1">
                    Label htmlFor="publicWhatsapp">WhatsApp PúblicoLabel>
                ...
                div>
                 div className="space-y-1">
                    Label htmlFor="mission">Misión / DescripciónLabel>
                ...
                div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  div>
                  div className="space-y-1">
                    Label htmlFor="profileState">Estado/ProvinciaLabel>
                  ...
                  div>
                  div className="space-y-1">
                    Label htmlFor="postalCode">Código PostalLabel>
            ...
            section className="space-y-4">
              h3 className="text-lg font-medium flex items-center border-b pb-2">MapPin className="mr-2 h-5 w-5 text-primary" /> Detalles de Rodadash3>
               div className="space-y-2">
                  Label>Días de RodadaLabel>
              ...
              div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                div className="space-y-1">
                  Label htmlFor="meetingTime">Hora de EncuentroLabel>
                ...
                div>
                div className="space-y-1">
                  Label htmlFor="meetingPointMapsLink">Enlace de Google MapsLabel>
            ...
            section className="space-y-4">
              h3 className="text-lg font-medium flex items-center border-b pb-2">User className="mr-2 h-5 w-5 text-primary" /> Información de Contacto (Interno)h3>
                div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                     div className="space-y-1">
                        Label htmlFor="contactName">Nombre Completo del ContactoLabel>
                    ...
                    div>
                    div className="space-y-1">
                        Label htmlFor="contactWhatsApp">WhatsApp del ContactoLabel>
