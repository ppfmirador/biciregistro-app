...
function ManageRidePageContent() {
    ...
    useEffect(() => {
        ...
        if (!user || user.role !== 'ngo') {
            toast({ title: "Acceso Denegado", description: "Debes ser una ONG para gestionar eventos.", variant: "destructive" });
        ...
        <div className="space-y-6">
            ...
            <Card className="max-w-2xl mx-auto shadow-xl">
                <CardHeader>
                    ...
                    <CardDescription>
                        {isCreating ? 'Completa los detalles para publicar un nuevo evento para tu comunidad.' : 'Modifica los detalles del evento.'}
                    </CardDescription>
                </CardHeader>
                <CardContent>
